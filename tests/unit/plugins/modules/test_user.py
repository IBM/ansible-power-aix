...
from .common.utils import (
    ...
    lsuser_output_path1, lsuser_output_path2
)
...
class TestCreateUser(unittest.TestCase):
    def setUp(self):
        ...
        # sample lsuser output
        with open(lsuser_output_path1, "r") as f:
            self.lsuser_output1 = f.read().strip()
        with open(lsuser_output_path2, "r") as f:
            self.lsuser_output2 = f.read().strip()
    ...
    def test_success_create_user_with_password_with_attributes(self):
        ...
        msg = user.create_user(self.module)
        pattern = 'Username is created SUCCESSFULLY: %s' % self.module.params["name"]
    ...
    def test_success_user_modify_without_password(self):
        ...
        self.assertRegexpMatches(pattern, msg)
    ...
    def test_change_account_locked_true_bool(self):
        ...
        user.modify_user(self.module)
        self.module.run_command.assert_called_with("chuser account_locked=\"true\"  test123")
    ...
    def test_change_account_locked_yes_quotes(self):
        ...
        user.modify_user(self.module)
        self.module.run_command.assert_called_with("chuser account_locked=\"yes\"  test123")
    ...
    def test_change_account_locked_always(self):
        ...
        user.modify_user(self.module)
        self.module.run_command.assert_called_with("chuser account_locked=\"always\"  test123")
    ...
    def test_change_account_locked_false_bool(self):
        ...
        self.module.run_command.side_effect = [
            (rc, self.lsuser_output2, stderr),
            (rc, stdout, stderr)
        ]

        user.modify_user(self.module)
        self.module.run_command.assert_called_with("chuser account_locked=\"false\"  test123")
    ...
    def test_change_account_locked_no_quotes(self):
        ...
        user.modify_user(self.module)
        self.module.run_command.assert_called_with("chuser account_locked=\"no\"  test123")
    ...
    def test_change_account_locked_never(self):
        ...
        user.modify_user(self.module)
        self.module.run_command.assert_called_with("chuser account_locked=\"never\"  test123")
    ...
    def test_modify_user_account_locked_capabilities(self):
        ...
        user.modify_user(self.module)
        self.module.run_command.assert_called_with("chuser account_locked=\"yes\" capabilities=\"CAP_AACCT\"  test123")
    ...
    def test_modify_user_account_locked_mixed_case_capabilities(self):
        ...
        user.modify_user(self.module)
        self.module.run_command.assert_called_with("chuser account_locked=\"false\" capabilities=\"CAP_AACCT\"  test123")

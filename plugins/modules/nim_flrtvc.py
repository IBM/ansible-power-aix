...
description:
- Use the NIM master to applies known security and HIPER (High Impact PERvasive) fixes on target
  systems based on their inventrory ensuring the systems are at supported and secure levels.
